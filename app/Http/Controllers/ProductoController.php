...
class ProductoController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       return view('farmaciasmmedihealthjd.productoIndex', ['productos' => $productos, 'search' => $query]);
        }
        //$productos = Producto::get();
        //return view('farmaciasmmedihealthjd.productoIndex', compact('productos'));
    }
    ...
    {
        return view('farmaciasmmedihealthjd.productoForm');
    }
    ...
    {  
        ...
        return view ('farmaciasmmedihealthjd.productoShow', compact('productos','sucursales'));
    }
    ...
    {
        return view ('farmaciasmmedihealthjd.productoForm', compact('producto'));
    }
